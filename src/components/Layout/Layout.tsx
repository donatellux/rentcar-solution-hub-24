    ...
    <div className="page-container">
      <div className="flex h-screen w-full overflow-hidden">
        ...
        <div className="flex-1 lg:ml-[280px] flex flex-col h-screen w-full min-w-0">
          ...
          <main className="page-content flex-1 overflow-y-auto overflow-x-hidden lg:desktop-page-content w-full">
            <div className="content-wrapper lg:desktop-table-container w-full">
              {children}
            </div>
          </main>
        </div>
